...
class Sidebar extends Component {
    ...
    render() {
        console.log('sddas', window.location.pathname);
        if (
            window.location.pathname !== '/customer' &&
            window.location.pathname !== '/customer/overview' &&
            window.location.pathname !== '/customer/help' &&
            window.location.pathname !== '/customer/pillow' &&
            window.location.pathname !== '/customer/return' &&
            window.location.pathname !== '/customer/oversized' &&
                                    ...
                                    <div>
                                        <ul>
                                            ...
                                            <li>
                                                <NavLink
                                                    to={
                                                        Constants.decorMirrorCurtainsCurtainsHardware
                                                    }
                                                    activeStyle={{
                                                        borderBottom: '1px solid gray',
                                                        padding: '0px',
